...
from compiler.frontend.ir import OpIR, ReductionOrder, Conv2dIR, MatMulIR, ElementwiseIR
from utils import im2col, conv2d, np_linear, np_relu, maxpool, quantize_int8
...
class TilingTransform(Transform):
    ...
    def tile_all(self, irs: list, data, hw: HardwareConfig, tile_dir: str = "build/tiles") -> tuple:
